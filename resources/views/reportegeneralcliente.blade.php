    ...
    <div class="sidebar-header">
     ...
     <nav class="sidebar-nav">
        ...
        <div class="nav-item">
         ...
         <div class="nav-item">
            <a href="{{ route('reporte.cliente') }}" class="nav-link active">
...
<div class="main-content">
    ...
    <div class="card period-selector-card">
        ...
        <form method="GET" action="{{ route('reporte.cliente') }}" class="row g-3 align-items-end">
            <div class="col-md-8">
        ...
        @if(request()->filled('periodo_id'))
            <form method="GET" action="{{ route('reporte.cliente.export') }}">
